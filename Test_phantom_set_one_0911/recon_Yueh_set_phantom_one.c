...
/////////////////initial////////////////////////////////////////////
            ...
            if(((ite+1)%5==0) || (ite<5))
            {
                if(x_plane==-40)
                {
                    ...
                    sprintf(out_name,"activity_set_phantom_zero_f_ite%d.DAT",ite+1);
                    FILE *fp1;
...
/////////////////initial////////////////////////////////////////////
            ...
            if(((ite+1)%5==0) || (ite<5))
            {
                if(x_plane==-40)
                {
                    ...
                    sprintf(out_name,"attenuation_set_phantom_zero_f_ite%d.DAT",ite+1);
                    FILE *fp2;
