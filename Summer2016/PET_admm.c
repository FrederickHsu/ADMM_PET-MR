...
// proxtv Solves total variation minimization problem via ADMM:
//
//      minimize  (1/2)||x - b||_2^2 + lambda * sum_i |x_{i+1} - x_i|
//
// where x is optimized object, b is measured histogram data, and
// lambda is corresponding regularization parameter.
...
/////////////////////proxTV iteration//////////////////////////////
    ...
    e = ones(n,1);
    D = spdiags([e -e], 0:1, n,n); // difference matrix
